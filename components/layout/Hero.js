  ...
  return (
    <>
      <motion.div
        ...
        className="w-full h-screen  mx-auto  flex justify-center sm:mb-20 md:mb-0 lg:mb-12 sm:py-28"
      >
        <motion.div
          initial="initial"
          animate="animate"
        ...
        >
          ...
          <div className="ml-3 flex flex-col justify-evenly relative w-2/3 xl:w-1/2 text-center">
            ...
            <div className="w-2/3 md:w-1/2 lg:w-1/3 mx-auto md:absolute md:left-1/3 md:top-full flex flex-row  justify-evenly items-center">
              <a href="https://drive.google.com/file/d/1C7BJTEMMc-wYu1XMGpyGoRiT3eDcCS3t/view">
                ...
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5 sm:h-4 sm:w-4 md:h-5 md:w-5 lg:h-5 lg:w-5 mr-3"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                  >
                    <path
              ...
              <a href="https://github.com/dtran5">
                <motion.button
                  ...
                  className="bg-white md:w-full sm:text-sm md:text-base flex justify-start items-center w-10/12 hover:bg-gray-100 text-gray-800  py-2 px-4 border border-gray-100 rounded shadow  sm:mx-0"
                >
                  <svg
                    className="mr-3 h-5 w-5 sm:h-4 sm:w-4 md:h-5 md:w-5 lg:h-5 lg:w-5"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="#000000"
                    viewBox="0 0 24 24"
                  >
              ...
              <a href="https://www.linkedin.com/feed/">
                ...
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    className="mr-3 h-4.5 w-4.5 sm:h-4 sm:w-4 md:h-5 md:w-5 lg:h-5 lg:w-5"
                  >
